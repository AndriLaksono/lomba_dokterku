...
<head>
  ...
  <link rel="stylesheet" href="<?=base_url()?>admin_assets/css/bootstrap.css" type="text/css" />
  <link rel="stylesheet" href="<?=base_url()?>admin_assets/css/animate.css" type="text/css" />
  <link rel="stylesheet" href="<?=base_url()?>admin_assets/css/font-awesome.min.css" type="text/css" />
  <link rel="stylesheet" href="<?=base_url()?>admin_assets/css/simple-line-icons.css" type="text/css" />
  <link rel="stylesheet" href="<?=base_url()?>admin_assets/css/font.css" type="text/css" />
  <link rel="stylesheet" href="<?=base_url()?>admin_assets/css/app.css" type="text/css" />
